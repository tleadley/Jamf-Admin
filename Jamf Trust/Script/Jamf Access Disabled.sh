...
# FEATURES:
#
# For more information, visit https://github.com/tleadley/
#
...
# Message to be shown to user for any required action
shw_msg 

# Cleanup any commands or files
clean_up 
